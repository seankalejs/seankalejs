...
**I turn technology into predictable revenue growth for clients.**
...
- 📋 CV in PDF: [ENG version](https://ikuz.me/assets/cv-en.pdf) · [RUS version](https://ikuz.me/assets/cv-ru.pdf)
- 📩 You can email me at [ivan@ikuz.me](mailto:ivan@ikuz.me)

## 📈 What I do

I run enterprise accounts on a marketing automation platform end to end: onboarding, CRM strategy, escalations, upsell.
Portfolio revenue grew **+40% YoY** in a difficult 2025; 30+ companies taken from onboarding to outcome.

The engineering start is why a conversation with a client's developers and a conversation with their commercial director fit in the same head.

## 🏆 Cases

Every number below comes from a publicly published client review — each link goes to the original source.

| Client | What happened | Result |
| --- | --- | --- |
| [Rive Gauche](https://mindbox.ru/journal/cases/otzyv-rivegaushe/) | Migrated all CRM communications of a national beauty chain: 88 cities, fragmented systems, 8 months | **+27.7%** revenue per customer · **21M** profiles migrated · **−45%** verification costs |
| [Pharmacy chain 36,6](https://mindbox.ru/journal/cases/kvizy-36-6/) | Quizzes instead of straight discounts across 2,600 pharmacies in 15 regions | **+4.5 pp** conversion to order · **4,230** contacts in 15 days |
| [A101](https://mindbox.ru/journal/cases/a101/) | Retail mechanics applied to real estate: behavioural triggers and ML-driven apartment recommendations | **+20%** enquiries from email · **+0.5 pp** email channel share |
| [Mnogo Lososya (X5 Group)](https://mindbox.ru/journal/cases/mnogolososya/) | Three services replaced by one platform for a delivery chain in 16 cities | **7.92%** of orders — CRM uplift · **19 hours** saved per month |
| [Kirovskiy](https://mindbox.ru/journal/cases/otzyv-kirovskiy/) | 152 stores: the loyalty programme became measurable | **+7%** receipt penetration per quarter · **48%** of revenue in 18 months |
| [Zaim Express](https://mindbox.ru/journal/cases/zaim-ekspress/) | CRM audit for a microfinance company | **+21%** channel revenue · applications share 3% → 8% · **−⅓** SMS costs |
| [CHARMSTORE](https://mindbox.ru/journal/cases/charmstore-webpush/) | Web push launched as a standalone channel for 22 stores | **5,000** subscribers in 4 months · ROMI **+325 pp** vs SMS |

The Rive Gauche migration was also [covered by CNews](https://retail.cnews.ru/news/line/2025-12-22_riv_gosh_perenes_crm-kommunikatsii).

## 🎤 Speaking

- **“How pharmacy chain 36,6 engages customers through quizzes”** — WE ARE CRM.PHARMA, March 2026
- **“Launching a loyalty programme: preparation, integration, pilot”** — Q&A expert at the Loyal Marketing conference, June 2025, Moscow, 400 attendees, alongside the Head of CRM & loyalty at L'Etoile and the marketing director of Zolla

## 🧠 What I'm good at

`Enterprise Customer Success` · `CRM marketing & loyalty` · `Negotiations & escalations` · `Working with C-level` · `B2B sales & upsell` · `Mentoring`

Also: [negotiations and client relations](https://bureau.ru/courses/certificate/f9b258c1fe02d6dc156e6f25ed69c0421461525/2039/) by Ilya Sinelnikov (Bureau Gorbunov, 2022), Mindbox School of Managers (2025), BOOST product vibe-coding intensive by Ivan Zamesin (2026).

## ⚙️ List of my technical skills and experience

Engineering base from six international B2B projects (VoIP, Linux, Oracle, Python) — still the reason I can read a client's integration myself.
